"""Cog that handles setting up logging and sending tracebacks to the owner per Discord PM, read from the log file."""
import asyncio
import logging
    ...
    try:
        async for _ in awatch(LOG_FILE):
            ...
            try:
                ...
                error_embed = discord.Embed(title="Long Traceback",
